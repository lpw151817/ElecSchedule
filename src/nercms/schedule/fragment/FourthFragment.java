...
public class FourthFragment extends Fragment implements OnClickListener {
	...
	TextView mTitle, mWeiZhiXing, mZhenZaiZhiXing, mZhenChang, mTiQian, mYanWu, mQuXiao;
	TextView mTitleYesterday, mWeiZhiXingYesterday, mZhenZaiZhiXingYesterday, mZhenChangYesterday,
			mTiQianYesterday, mYanWuYesterday, mQuXiaoYesterday;
	...
	private void initView(View view) {
		...
		Date theDayBeforeYesterday = new Date(tmp.getYear(), tmp.getMonth(), tmp.getDate() - 1);
		...
		mWeiZhiXing.setText(
				dao.getPlanTasks(4, 3, null, "0", yesterday.getTime() + "", today.getTime() + "")
						.size() + "");

		mZhenZaiZhiXing = (TextView) view.findViewById(R.id.zhengzai);
		mZhenZaiZhiXing.setText(
				dao.getPlanTasks(4, 3, null, "1", yesterday.getTime() + "", today.getTime() + "")
						.size() + "");

		mZhenChang = (TextView) view.findViewById(R.id.zhengchang);
		mZhenChang.setText(
				dao.getPlanTasks(4, 3, null, "3", yesterday.getTime() + "", today.getTime() + "")
						.size() + "");
		...
		mYanWu.setText(
				dao.getPlanTasks(4, 3, null, "2", yesterday.getTime() + "", today.getTime() + "")
						.size() + "");
		mQuXiao = (TextView) view.findViewById(R.id.quxiao);
		mQuXiao.setText(
				dao.getPlanTasks(4, 3, null, "4", yesterday.getTime() + "", today.getTime() + "")
						.size() + "");
		...
		mWeiZhiXingYesterday = (TextView) view.findViewById(R.id.weizhixin_yesterday);
		mWeiZhiXingYesterday.setText(dao.getPlanTasks(4, 3, null, "0",
				theDayBeforeYesterday.getTime() + "", yesterday.getTime() + "").size() + "");
		mZhenZaiZhiXingYesterday = (TextView) view.findViewById(R.id.zhengzai_yesterday);
		mZhenZaiZhiXingYesterday.setText(dao.getPlanTasks(4, 3, null, "1",
				theDayBeforeYesterday.getTime() + "", yesterday.getTime() + "").size() + "");
		mZhenChangYesterday = (TextView) view.findViewById(R.id.zhengchang_yesterday);
